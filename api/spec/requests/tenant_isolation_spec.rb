...
RSpec.describe 'Tenant Isolation' do
  ...
  describe 'Assessments' do
    let!(:assessment_a) { create(:assessment, tenant_id: tenant_a.id, created_by: user_a, name: 'Assessment A') }
    let!(:assessment_b) { create(:assessment, tenant_id: tenant_b.id, created_by: user_b, name: 'Assessment B') }
  ...
  describe 'Sessions' do
    let!(:assessment_a) { create(:assessment, tenant_id: tenant_a.id, created_by: user_a) }
    let!(:assessment_b) { create(:assessment, tenant_id: tenant_b.id, created_by: user_b) }
  ...
  describe 'Vacancies' do
    let!(:vacancy_a) { create(:vacancy, tenant_id: tenant_a.id, created_by: user_a, role_title: 'Vacancy A') }
    let!(:vacancy_b) { create(:vacancy, tenant_id: tenant_b.id, created_by: user_b, role_title: 'Vacancy B') }
